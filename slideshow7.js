...
var ZTSlideShow7 = new Class({
	...
	initSlide:function(){		
		...
		slidedes=new Fx.Morph(this.slideDes[0],{duration:this.options.slide7Duration,transition: Fx.Transitions.Sine.easeInOut}).start({'height': [0,90]});
	},
    ...
    goTo:function(num,wait){    	
    	...
    	this.fx.start({'left':-num*this.sizeSlideItem + this.offset}).chain(function(){
            ...
            slide = new Fx.Morph(this.slideDes[num], {duration:this.options.slide7Duration,transition: Fx.Transitions.Sine.easeInOut}).start({'height': [0,90]});
    	}.bind(this));    	    	
